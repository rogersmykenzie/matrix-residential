...
const ADD_BEDROOM = "ADD_BEDROOM";
//action creators
export function addBedroom(bedroom) {
  return {
    type: ADD_BEDROOM,
    payload: bedroom
  };
...
export default function reducer(state = initialState, action) {
  switch (action.type) {
    ...
    case REMOVE_CONSTRUCTION_TYPE:
      ...
      newConstructionTypes.splice(
        newConstructionTypes.findIndex(val => {
    ...
    case REMOVE_PROPERTY_TYPE:
      ...
      newPropertyTypes.splice(
        newPropertyTypes.findIndex(val => {
          return val === action.payload;
        }),
        1
      );
    ...
    case REMOVE_HOUSING_TYPE:
      ...
      newHousingTypes.splice(
        newHousingTypes.findIndex(val => {
          return val === action.payload;
        }),
        1
      );
    ...
    case REMOVE_HOME_STYLE:
      ...
      newHomeStyles.splice(
        newHomeStyles.findIndex(val => {
          return val === action.payload;
        }),
        1
      );
